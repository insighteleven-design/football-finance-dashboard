...
const plRaw: Record<string, RawEntry> = {
  ...
  aston_villa:    { revenue: 275.70, wage_bill: 252.00, operating_profit: -145.30, profit_from_player_sales:  64.70, pre_tax_profit:  -85.90, net_debt:   24.90, cash:    0.00, fiscal_year_end: "2024-06-30", data_confidence: "high",
    prior_year: { fiscal_year_end: "2023-06-30", revenue:  217.7, wage_bill:  194.2, wage_ratio:  89, operating_profit: -139.5, profit_from_player_sales:   22.5, pre_tax_profit:  -120.3, net_debt:    -0.2, compare_division: "premier-league" } },
  ...
  crystal_palace: { revenue: 190.20, wage_bill: 133.70, operating_profit:  -20.70, profit_from_player_sales:   1.30, pre_tax_profit:  -32.90, net_debt:  148.90, cash:    8.86, fiscal_year_end: "2024-06-30", data_confidence: "high",
    prior_year: { fiscal_year_end: "2023-06-30", revenue:  180.1, wage_bill:  130.6, wage_ratio:  73, operating_profit:  -19.9, profit_from_player_sales:    0.3, pre_tax_profit:   -27.5, net_debt:   109.1, compare_division: "premier-league" } },
  everton:        { revenue: 186.90, wage_bill: 156.60, operating_profit:  -92.70, profit_from_player_sales:  48.50, pre_tax_profit:  -53.20, net_debt: 1018.10, cash:   26.42, fiscal_year_end: "2024-06-30", data_confidence: "high",
    prior_year: { fiscal_year_end: "2023-06-30", revenue:  172.2, wage_bill:  159.0, wage_ratio:  92, operating_profit: -130.5, profit_from_player_sales:   47.5, pre_tax_profit:   -89.1, net_debt:   781.3, compare_division: "premier-league" } },
  fulham:         { revenue: 181.60, wage_bill: 154.80, operating_profit:  -64.90, profit_from_player_sales:  32.70, pre_tax_profit:  -32.10, net_debt:   92.20, cash:   32.77, fiscal_year_end: "2024-06-30", data_confidence: "high",
    prior_year: { fiscal_year_end: "2023-06-30", revenue:  182.3, wage_bill:  139.1, wage_ratio:  76, operating_profit:  -35.2, profit_from_player_sales:    8.7, pre_tax_profit:   -26.1, net_debt:   -50.3, compare_division: "premier-league" } },
  ...
  sunderland:     { revenue:  38.20, wage_bill:  31.40, operating_profit:  -16.90, profit_from_player_sales:   8.80, pre_tax_profit:   -8.60, net_debt:   28.10, cash:   20.71, fiscal_year_end: "2024-07-31", data_confidence: "high", compare_division: "championship",
    prior_year: { fiscal_year_end: "2023-07-31", revenue:   35.5, wage_bill:   25.6, wage_ratio:  72, operating_profit:   -9.3, profit_from_player_sales:    0.3, pre_tax_profit:    -8.9, net_debt:    15.7, compare_division: "championship" } },
  ...
  wolves:         { revenue: 177.70, wage_bill: 141.90, operating_profit:  -73.30, profit_from_player_sales:  64.60, pre_tax_profit:  -14.30, net_debt:   72.70, cash:   33.44, fiscal_year_end: "2024-05-31", data_confidence: "high", compare_division: "championship",
    prior_year: { fiscal_year_end: "2023-05-31", revenue:  168.6, wage_bill:  141.6, wage_ratio:  84, operating_profit: -100.7, profit_from_player_sales:   43.9, pre_tax_profit:   -67.2, net_debt:   145.6, compare_division: "premier-league" } },
};
...
const chRaw: Record<string, RawEntry> = {
  ...
  bristol_city:   { revenue:  40.30, wage_bill:  35.90, operating_profit:  -18.84, profit_from_player_sales:   5.80, pre_tax_profit:  -18.60, net_debt:   20.74, cash:    0.03, fiscal_year_end: "2025-06-30",
  ...
  ipswich:        { revenue: 155.42, wage_bill:  77.14, operating_profit:   -6.21, profit_from_player_sales:  15.40, pre_tax_profit:    4.01, net_debt:   -4.59, cash:   13.67, fiscal_year_end: "2025-06-30", compare_division: "premier-league",
  ...
  leicester:      { revenue: 105.35, wage_bill: 107.16, operating_profit:   -8.98, profit_from_player_sales:   7.27, pre_tax_profit:  -19.43, net_debt:  199.25, cash:    7.09, fiscal_year_end: "2024-06-30", compare_division: "premier-league" },
  ...
  millwall:       { revenue:  29.30, wage_bill:  28.63, operating_profit:    1.05, profit_from_player_sales:   0.00, pre_tax_profit:   -0.30, net_debt:    null, cash:    0.79, fiscal_year_end: "2025-06-30",
  ...
  portsmouth:     { revenue:  24.57, wage_bill:  17.43, operating_profit:   -1.45, profit_from_player_sales:   0.39, pre_tax_profit:   -4.36, net_debt:    6.15, cash:    2.04, fiscal_year_end: "2025-06-30", data_confidence: "medium",
  ...
  southampton:    { revenue: 157.52, wage_bill: 113.96, operating_profit:  -62.25, profit_from_player_sales:  28.44, pre_tax_profit:  -53.90, net_debt:   -9.35, cash:    9.35, fiscal_year_end: "2025-06-30", compare_division: "premier-league",
  ...
  stoke:          { revenue:  35.44, wage_bill:  30.30, operating_profit:  -29.54, profit_from_player_sales:   0.15, pre_tax_profit:  -28.31, net_debt:  158.00, cash:   25.52, fiscal_year_end: "2025-05-31",
  ...
  swansea:        { revenue:  21.54, wage_bill:  27.35, operating_profit:  -25.20, profit_from_player_sales:   4.52, pre_tax_profit:  -15.19, net_debt:   -1.62, cash:    5.31, fiscal_year_end: "2024-06-30", data_confidence: "medium",
  ...
  west_brom:      { revenue:  30.35, wage_bill:  37.05, operating_profit:  -20.25, profit_from_player_sales:   9.20, pre_tax_profit:  -17.00, net_debt:   71.85, cash:    0.47, fiscal_year_end: "2025-06-30",
...
const l1Raw: Record<string, RawEntry> = {
  ...
  mansfield:      { revenue: null,  wage_bill: null,  operating_profit:  null,  profit_from_player_sales: null, pre_tax_profit:  null,  net_debt:   6.82, cash: null, fiscal_year_end: "2025-06-30" },
  ...
  plymouth:       { revenue: 28.83, wage_bill: 21.25, operating_profit:   0.22, profit_from_player_sales: null, pre_tax_profit:   0.32, net_debt:  10.80, cash: null, fiscal_year_end: "2025-06-30", data_confidence: "high", compare_division: "championship",
  ...
  port_vale:      { revenue: null,  wage_bill: null,  operating_profit:  null,  profit_from_player_sales: null, pre_tax_profit:  null,  net_debt:   5.60, cash: null, fiscal_year_end: "2025-06-30", compare_division: "league-two",
    prior_year: { fiscal_year_end: "2024-06-30", revenue: null,  wage_bill: null,  wage_ratio: null, operating_profit: null,  profit_from_player_sales: null, pre_tax_profit: null,  net_debt:   5.29, compare_division: "league-two" } },
  ...
  stevenage:      { revenue: null,  wage_bill: null,  operating_profit:  null,  profit_from_player_sales: null, pre_tax_profit:  null,  net_debt:   4.54, cash: null, fiscal_year_end: "2025-06-30",
    prior_year: { fiscal_year_end: "2024-06-30", revenue: null,  wage_bill: null,  wage_ratio: null, operating_profit: null,  profit_from_player_sales: null, pre_tax_profit: null,  net_debt:   2.17 } },
