...
const chRaw: Record<string, RawEntry> = {
  ...
  west_brom:      { revenue:  30.35, wage_bill:  37.05, operating_profit:  -20.25, profit_from_player_sales:   9.20, pre_tax_profit:  -19.99, net_debt:   97.51, cash:    0.47, fiscal_year_end: "2025-06-30",
...
const l2Raw: Record<string, RawEntry> = {
  ...
  harrogate:      { revenue:   4.06, wage_bill:   3.53, operating_profit:   -2.17, pre_tax_profit:   -2.17, net_debt:   -0.10, cash:    0.11, fiscal_year_end: "2025-06-30",
    data2023: { fiscal_year_end: "2023-06-30", revenue:  null, wage_bill:  null, wage_ratio:  null, operating_profit:  null, profit_from_player_sales:  null, pre_tax_profit: -2.48, net_debt:  null, compare_division: "league-two" },
  ...
  mk_dons:        { revenue:   5.72, wage_bill:   5.22, operating_profit:   -3.70, pre_tax_profit:   -3.09, net_debt:   -0.33, cash:    0.33, fiscal_year_end: "2024-06-30",
