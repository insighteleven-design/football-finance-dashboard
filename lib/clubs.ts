...
const chRaw: Record<string, RawEntry> = {
  ...
  leicester:      { revenue: 105.35, wage_bill: 107.16, operating_profit:   -8.98, profit_from_player_sales:  71.84, pre_tax_profit:  -19.43, net_debt:  218.88, cash:    7.09, fiscal_year_end: "2024-06-30", compare_division: "premier-league",
    data2023: { fiscal_year_end: "2023-06-30", revenue: 177.33, wage_bill: 205.78, wage_ratio: 116, operating_profit: -152.01, profit_from_player_sales: 74.77, pre_tax_profit:  -89.72, net_debt:  58.47, compare_division: "premier-league" },
  ...
  west_brom:      { revenue:  30.35, wage_bill:  37.05, operating_profit:  -29.44, profit_from_player_sales:   9.20, pre_tax_profit:  -19.99, net_debt:   -0.41, cash:    0.47, fiscal_year_end: "2025-06-30",
...
const l1Raw: Record<string, RawEntry> = {
  ...
  leyton_orient:  { revenue:  9.43, wage_bill: null,  operating_profit:  -4.62, profit_from_player_sales:  0.50, pre_tax_profit:  -4.61, net_debt:  -0.74, cash:  0.74, fiscal_year_end: "2025-06-30",
  ...
  stockport:      { revenue:  9.20, wage_bill: null,  operating_profit:  -7.00, profit_from_player_sales: null, pre_tax_profit:  null,  net_debt:   1.26, cash:  0.48, fiscal_year_end: "2025-06-30",
    ...
    data2022:   { fiscal_year_end: "2022-06-30", revenue: null, wage_bill: null, wage_ratio: null, operating_profit: null, profit_from_player_sales: null, pre_tax_profit: null, net_debt:   0.80, compare_division: "league-two" } },
  ...
  wycombe:        { revenue: null,  wage_bill: null,  operating_profit:  null,  profit_from_player_sales: null, pre_tax_profit:  -9.80, net_debt:  -1.79, cash:  1.79, fiscal_year_end: "2025-06-30",
    ...
    data2023:   { fiscal_year_end: "2023-06-30", revenue: null, wage_bill: null, wage_ratio: null, operating_profit: null, profit_from_player_sales: null, pre_tax_profit: null, net_debt:  -0.02, compare_division: "league-one" },
    data2022:   { fiscal_year_end: "2022-06-30", revenue: null, wage_bill: null, wage_ratio: null, operating_profit: null, profit_from_player_sales: null, pre_tax_profit: null, net_debt:   0.10, compare_division: "league-one" } },
};
...
const l2Raw: Record<string, RawEntry> = {
  bristol_rovers: { revenue:   8.11, wage_bill:   8.91, operating_profit:   -6.47, pre_tax_profit:   -6.75, net_debt:   -0.78, cash:    1.31, fiscal_year_end: "2025-06-30", data_confidence: "high", compare_division: "league-one",
    prior_year: { fiscal_year_end: "2024-06-30", revenue:  7.47, wage_bill:  null, wage_ratio:  null, operating_profit: -5.88, profit_from_player_sales:  0.86, pre_tax_profit: -5.30, net_debt:  0.90, compare_division: "league-one" },
    data2023: { fiscal_year_end: "2023-06-30", revenue:  7.28, wage_bill:  null, wage_ratio:  null, operating_profit: -4.11, profit_from_player_sales:  0.18, pre_tax_profit: -3.99, net_debt:  1.10, compare_division: "league-one" },
    data2022: { fiscal_year_end: "2022-06-30", revenue:  6.30, wage_bill:  null, wage_ratio:  null, operating_profit: -3.77, profit_from_player_sales:  null, pre_tax_profit: -3.79, net_debt: -0.18, compare_division: "league-two" } },
  bromley:        { revenue:   5.27, wage_bill:   null, operating_profit:   -1.06, pre_tax_profit:   -1.09, net_debt:    0.42, cash:    0.50, fiscal_year_end: "2024-12-31",
    prior_year: { fiscal_year_end: "2023-12-31", revenue:  3.98, wage_bill:  null, wage_ratio:  null, operating_profit: -0.43, profit_from_player_sales:  null, pre_tax_profit: -0.46, net_debt:  0.69, compare_division: "league-two" },
    data2023: { fiscal_year_end: "2022-12-31", revenue:  3.98, wage_bill:  null, wage_ratio:  null, operating_profit: -0.43, profit_from_player_sales:  null, pre_tax_profit: -0.46, net_debt:  0.69 },
    data2022: { fiscal_year_end: "2021-12-31", revenue:  3.38, wage_bill:  null, wage_ratio:  null, operating_profit: -0.79, profit_from_player_sales:  null, pre_tax_profit: -0.81, net_debt:  0.74 } },
  ...
  crewe:          { revenue:   5.20, wage_bill:   null, operating_profit:   -1.16, pre_tax_profit:   -1.16, net_debt:    1.16, cash:    0.10, fiscal_year_end: "2025-06-30",
    prior_year: { fiscal_year_end: "2024-06-30", revenue:  5.27, wage_bill:  null, wage_ratio:  null, operating_profit: -0.79, profit_from_player_sales:  null, pre_tax_profit: -0.79, net_debt:  0.15, compare_division: "league-two" },
    data2023: { fiscal_year_end: "2023-06-30", revenue:  3.96, wage_bill:  null, wage_ratio:  null, operating_profit: -1.45, profit_from_player_sales:  null, pre_tax_profit: -1.45, net_debt:  0.05, compare_division: "league-two" },
    data2022: { fiscal_year_end: "2022-06-30", revenue:  5.74, wage_bill:  null, wage_ratio:  null, operating_profit:  0.15, profit_from_player_sales:  null, pre_tax_profit:  0.15, net_debt: -0.05, compare_division: "league-one" } },
  ...
  harrogate:      { revenue:   4.06, wage_bill:   3.53, operating_profit:   -2.17, pre_tax_profit:   -2.17, net_debt:   -0.10, cash:    0.11, fiscal_year_end: "2025-06-30",
    prior_year: { fiscal_year_end: "2024-06-30", revenue:  3.07, wage_bill:  3.62, wage_ratio:  118, operating_profit: -3.07, profit_from_player_sales:  0.54, pre_tax_profit: -2.53, net_debt: -0.06, compare_division: "league-two" },
    data2023: { fiscal_year_end: "2023-06-30", revenue:  null, wage_bill:  null, wage_ratio:  null, operating_profit:  null, profit_from_player_sales:  null, pre_tax_profit: -2.48, net_debt: -0.13, compare_division: "league-two" },
    data2022: { fiscal_year_end: "2022-06-30", revenue:  null, wage_bill:  null, wage_ratio:  null, operating_profit:  null, profit_from_player_sales:  null, pre_tax_profit: -1.17, net_debt:  null, compare_division: "league-two" } },
  mk_dons:        { revenue:   5.72, wage_bill:   5.22, operating_profit:   -3.70, profit_from_player_sales:  0.64, pre_tax_profit:   -3.09, net_debt:   -0.33, cash:    0.33, fiscal_year_end: "2024-06-30",
